<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/PopUp.Master" CodeBehind="OrificeDataSheet.aspx.cs" Inherits="chartDemo.GeneralPages.OrificeDataSheet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header"><asp:Label ID="lblTagNumber" runat="server" ></asp:Label> - Orifice</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>
