<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/PopUp.Master" CodeBehind="UltraSonicDataSheet.aspx.cs" Inherits="chartDemo.GeneralPages.UltraSonicDataSheet" %>
    ...
    <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                                ...
                                <tr>
                                <td><h4>Line Size</h4></td><td><h4><small>Units</small></h4></td><td><h4><small>Pipe Schedule</small></h4></td>
                                <td><h4><small><asp:Label ID="Label1" runat="server" Text="-" /></small></h4></td><td><h4><small><asp:Label ID="Label2" runat="server" Text="-" /></small></h4></td>
                                <td><h4><small><asp:Label ID="Label3" runat="server" Text="-" /></small></h4></td>
                                </tr>
                                <tr>
                                <td colspan="3"><h4>Pipe Material</h4></td>
                                <td colspan="3"><h4><small><asp:Label ID="Label4" runat="server" Text="-" /></small></h4></td>
                                </tr>
                                <tr>
                                <td><h4>Pipe Insulation</h4></td><td><h4><small>Insulation Thickness</small></h4></td><td><h4><small>Units</small></h4></td>
                                <td><h4><small><asp:Label ID="Label5" runat="server" Text="-" /></small></h4></td><td><h4><small><asp:Label ID="Label6" runat="server" Text="-" /></small></h4></td>
                                <td><h4><small><asp:Label ID="Label7" runat="server" Text="-" /></small></h4></td>
                                </tr>
                                <tr>
                                <td><h4>Pipe ID</h4></td><td><h4><small>Units</small></h4></td><td><h4><small>Line Orientation</small></h4></td>
                                <td><h4><small><asp:Label ID="Label9" runat="server" Text="-" /></small></h4></td><td><h4><small><asp:Label ID="Label10" runat="server" Text="-" /></small></h4></td>
                                <td><h4><small><asp:Label ID="Label11" runat="server" Text="-" /></small></h4></td>
                                </tr>
                                </table>
                        </div></div>
                        ...
                        <div class="panel-body">
                                <table class="table table-condensed table-bordered datasheettable">
                                <tr>
                                <td><h4>Mounting</h4></td><td colspan="2"><h4><small>Temperature Compensator</small></h4></td>
