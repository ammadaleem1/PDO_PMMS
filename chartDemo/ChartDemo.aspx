<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChartDemo.aspx.cs" Inherits="chartDemo.ChartDemo" Title="Operating Envelop" %>
...
<body>
    ...
    <tr><td colspan="8"><label
                    ...
                    <tr align="center">
                            <td style="font-weight: bold; font-size: 20px" align="center" colspan="8" runat="server" id="tdTitle">
        ...
        <tr><td colspan="8" align="left"><label style="color: Red; font-size: 11px;">Avoid long time duration selection as it takes too long to retrieve data. </label> <input type="button" onclick="return openTestDetails()" value="View Tests" class="buttonClass" /><%--</td><td style="padding-right:20px">--%>
                <asp:Button ID="btnCalculate" runat="server" OnClick="btnCalculate_Click" OnClientClick="return validateDate();" Text="View Envelope" CssClass="buttonClass" Width="100px" />
            </td></tr>
    </table></td></tr></table>
    <!-- end table filters -->
            </td>
                    ...
                    <asp:Chart ID="OpEnv" runat="server" BackColor="#efefef" Height="510px" Width="800px">
                        ...
                        <ChartAreas>
                            ...
                            <asp:ChartArea Name="ChartArea" BackColor="LightBlue">
                                <%--<AxisY IsLogarithmic="true" Minimum="0.001" Maximum="100" LogarithmBase="10" LabelAutoFitStyle="None"--%>
                                <AxisY IsLogarithmic="false" Minimum="1" Maximum="100"  LabelAutoFitStyle="None"
                                    TitleFont="Callibri, 14px, style=Bold" Title="Liquid (m3/d)">
                                    <MajorGrid LineColor="Gray" />
                                ...
                                <%--<AxisX IsLogarithmic="true" Minimum="0.001" Maximum="100" LogarithmBase="10" LabelAutoFitStyle="None"--%>
                                <AxisX IsLogarithmic="false" Minimum="1" Maximum="100"  LabelAutoFitStyle="None"
                                    TitleFont="Callibri, 14px, style=Bold" Title="Gas (sm3/d)">
                                    <MajorGrid LineColor="Gray" />
                                    <MinorGrid Enabled="True" Interval="1" LineColor="Black" />
                                    <ScaleBreakStyle Enabled="True" />
                                </AxisX>
                ...
                <td>
                    <table align="" cellpadding="5" cellspacing="5" class="PropertyTable">
                        <tr align="left">
                            ...
                            <td width="35%">
                                No of Points outside the Envelope
                            </td>
                            <td width="10%">
                                <asp:Label ID="lblOutsideEnvelopNumber" runat="server" CssClass="PropertyLabel"></asp:Label>
                            </td>
                        </tr>
                        <tr align="left">
                            <td>
                            ...
                            <td>
                                <asp:Label ID="lblOutsideEnvelopPercent" runat="server" CssClass="PropertyLabel"></asp:Label>
                            </td>
                        </tr>
            ...
            <asp:Chart ID="chartMinMaxPercent" runat="server" BackColor="#efefef" Height="200px" Width="390px">
                        <Series> 
      <asp:Series Name="MinMaxPercent" YValueType="Int32" ChartType="Column" ChartArea="MainChartArea" > 
         <Points> 
            <asp:DataPoint AxisLabel="Within Envelope(%)" YValues="55" /> 
            <asp:DataPoint AxisLabel="Outside Envelope(%)" YValues="45" /> 
         </Points> 
      </asp:Series> 
   </Series> 
   <ChartAreas> 
      <asp:ChartArea Name="MainChartArea" BackColor="Black"><AxisX><MajorGrid LineColor="LightPink" /></AxisX> <AxisY LineWidth="1"><MajorGrid LineColor="LightPink" /></AxisY>
            ...
            <asp:Chart ID="chartMinMaxNumber" runat="server" BackColor="#efefef" Height="200px" Width="390px" style="padding-left:16px;">
                        <Series> 
      <asp:Series Name="MinMaxNumber" YValueType="Int32" ChartType="Column" ChartArea="MainChartArea" MarkerSize="5"> 
         <Points> 
            <asp:DataPoint AxisLabel="Within Envelope(Pts)" YValues="390" /> 
            <asp:DataPoint AxisLabel="Outside Envelope(Pts)" YValues="355" /> 
         </Points> 
      </asp:Series> 
   </Series> 
   <ChartAreas> 
      <asp:ChartArea Name="MainChartArea" BackColor="Black"><AxisX><MajorGrid LineColor="LightPink" /></AxisX> <AxisY><MajorGrid LineColor="LightPink" /></AxisY>
            ...
            <td align="left" style="border:1px solid #000000;">
                <asp:Chart ID="chartPressureTrend" runat="server" BackColor="#efefef" Height="300px" Width="500px">
                    ...
                    <ChartAreas>
                        <asp:ChartArea Name="MainChartArea" BackColor="Black"><AxisX Title="Pressure(Kpa)" TitleFont="Callibri, 12px, style=UnderLine"><LabelStyle Format="dd/MM/yyyy\\nhh:mm"  /><MajorGrid LineColor="LightPink" /></AxisX><AxisY><MajorGrid LineColor="LightPink" /></AxisY></asp:ChartArea>
                    </ChartAreas>
            ...
            <td align="left" style="border:1px solid #000000;">
                <asp:Chart ID="chartGrossFlowTrend" runat="server" BackColor="#efefef" Height="300px" Width="500px">
                    ...
                    <ChartAreas>
                        <asp:ChartArea Name="MainChartArea" BackColor="Black"><AxisX Title="GrossFlow(m3/day)" TitleFont="Callibri, 12px, style=UnderLine"><LabelStyle Format="dd/MM/yyyy\\nhh:mm"  /><MajorGrid LineColor="LightPink" /></AxisX><AxisY><MajorGrid LineColor="LightPink" /></AxisY></asp:ChartArea>
                    </ChartAreas>
                </asp:Chart>
                </td>
            </tr>
            ...
            <td align="left" style="border:1px solid #000000;">
                <asp:Chart ID="chartTemperatureTrend" runat="server" BackColor="#efefef" Height="300px" Width="500px">
                    ...
                    <ChartAreas>
                        <asp:ChartArea Name="MainChartArea" BackColor="Black"><AxisX Title="Temperature(Degree C)" TitleFont="Callibri, 12px, style=UnderLine"><LabelStyle Format="dd/MM/yyyy\\nhh:mm"  /><MajorGrid LineColor="LightPink" /></AxisX><AxisY><MajorGrid LineColor="LightPink" /></AxisY></asp:ChartArea>
                    </ChartAreas>
                </asp:Chart>
                </td>
            </tr>
