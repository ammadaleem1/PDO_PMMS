<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AggregateStats.aspx.cs" Inherits="chartDemo.AggregateStats"
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript"><asp:PlaceHolder runat="server">
...
<body>
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
     ...
     <table><tr><td valign="top" style="border-right: 1px solid black;">
     <ul class="treeview-list" style="margin-left: 30px;"><li class="treeview-item">
     <telerik:RadTreeView ID="RadTreeView1" runat="server" Width="100%" 
                DataFieldID="ItemID" DataFieldParentID="ParentID" DataTextField="ItemName"
                DataSourceID="SqlDataSource13" OnNodeClick="RadTreeView1_NodeClick" MultipleSelect="false" OnClientNodeClicked="ClientNodeClicked">
                <DataBindings>
                    <telerik:RadTreeNodeBinding Expanded="true"></telerik:RadTreeNodeBinding>
                </DataBindings>
            </telerik:RadTreeView></li></ul></td><%--</tr></table>--%><td style="width:3px;"></td><td valign="top" style="border-right: 1px solid black;">
