<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialBalanceChart.aspx.cs" Inherits="chartDemo.MaterialBalanceChart" %>
...
<body>
    ...
    <asp:HiddenField ID="hdnInput" runat="server"  />
    ...
    <tr><td colspan="9"><label
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="rfvMinutesStart" runat="server" Display="Dynamic" ControlToValidate="ddlMinutesStart" ErrorMessage="*" CssClass="validators" ValidationGroup="asfd"></asp:RequiredFieldValidator>
            </td>
        ...
        <tr>
            ...
            <td><asp:Button ID="btnCalculate" runat="server" OnClick="btnCalculate_Click" OnClientClick="return validateDate();" Text="View Chart" /></td>
        </tr>
        ...
        <tr>
        <td>
            <asp:Chart ID="chartMaterialBalance" runat="server" BackColor="#efefef" Height="500px" Width="700px">
                    <Series>
                        <asp:Series BorderWidth="1" Name="Input" ChartType="Line" Color="Green"></asp:Series>
                        <asp:Series BorderWidth="1" Name="Output" ChartType="Line" Color="Red"></asp:Series>
                    </Series>
                    <ChartAreas>
                        <asp:ChartArea Name="MainChartArea" BackColor="Black"><AxisX Title="Material balance chart" TitleFont="Callibri, 12px, style=UnderLine"><LabelStyle Format="dd/MM/yyyy\\nhh:mm"  /><MajorGrid LineColor="LightPink" /></AxisX><AxisY><MajorGrid LineColor="LightPink" /></AxisY></asp:ChartArea>
                    </ChartAreas>
                </asp:Chart>
        </td>
        </tr>
